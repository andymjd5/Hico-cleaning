...
const sanitizeAgentForDb = (agent: Agent) => {
  return {
    ...
    commune_id: agent.commune_id || 'all',
    commune_nom: agent.commune_nom || 'Toutes les communes (Kinshasa)',
    capacite_camion: agent.capacite_camion || 6,
    charge_actuelle: agent.charge_actuelle || 0
  };
};
                ...
                <div className="p-6 font-sans flex flex-col gap-4 max-h-[70vh] overflow-y-auto">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex justify-between items-center bg-background px-4 py-2 rounded-t-xl border border-outline-variant border-b-0">
                      ...
                      <button 
                        onClick={() => {
                          navigator.clipboard.writeText(HICO_COMPLETE_SUPABASE_SQL);
                    ...
                    <pre className="p-4 bg-black rounded-b-xl border border-outline-variant text-[11px] text-[#10b981] font-mono overflow-x-auto max-h-[250px] leading-relaxed whitespace-pre-wrap">
{HICO_COMPLETE_SUPABASE_SQL}
                    </pre>
                  </div>
